...
\begin{itemize}
    ...
    En el ámbito de la computación de alto rendimiento (HPC), es el estándar para la gestión de Entrada/Salida (E/S) debido a su capacidad para manejar estructuras jerárquicas y soportar E/S paralela.
