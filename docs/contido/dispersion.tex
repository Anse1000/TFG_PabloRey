...
La misión \textbf{GAIA}~\cite{gaia_mission_esa} de la Agencia Espacial Europea (ESA) es uno de los proyectos más ambiciosos de la astronomía moderna.
...
\begin{itemize}
    \item \texttt{rgeo}: Distancia geométrica estimada en parsecs (pc)\footnote{1 parsec equivale a 3.26 años luz o $3,0857 \times 10^{13}$ km} basada en el método bayesiano desarrollado por Bailer-Jones~\cite{Bailer-Jones2021}.
...
\]
En este trabajo se adoptan los valores propuestos por Schönrich et al y Bland-Hawthorn et al~\cite{schonrich2010,blandhawthorn2016} para el movimiento solar:
...
Tal y como se observa en el diagrama Color-Magnitud de la Figura~\ref{fig:hr_diagram}, la Secuencia Principal (SP) no es una dispersión aleatoria, sino una banda diagonal bien definida donde la posición de una estrella está determinada casi unívocamente por su masa.
\begin{figure}[H]
    \centering
...
Para realizar la simulación propiamente se emplea un integrador simétrico de segundo orden tipo \emph{Leapfrog} conocido como Kick--Drift--Kick~\cite{hockney1988,saha1992,springel2005}.
